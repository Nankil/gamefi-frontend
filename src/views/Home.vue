  ...
  <div class="dark:text-white text-purple-600">
    ...
    <div class="h-52 flex">
      ...
      <div class="w-1/4 flex flex-col">
        <div class="border-2 border-solid border-white flex-1 text-xs h-1/5">
    ...
    <div class="flex flex-row">
      <div class="flex-1 mr-10">
        ...
        <div class="border-2 border-solid border-white h-96">
          ...
          <div class="text-center border-b-2 border-solid border-white">
            ≈ $ 10,000.008
          </div>
          <div class="mx-3 h-60">
            <div class="h-1/5 flex">
              <div class="w-1/6 mx-1 h-full"><img src="" alt="" /></div>
              <div class="w-1/2">
                <div class="text-yellow-600">BHD</div>
                <div class="truncate text-xs">0x7fe….g8ff [ 複製 ]</div>
              </div>
      ...
      <div class="flex-1">
        ...
        >
          <div class="mx-3 my-1">
            <div class="text-purple-500">会员注册人数</div>
            <div class="text-yellow-700 text-xs">10000</div>
          </div>
          <div class="mx-3 my-1">
            <div class="text-purple-500">会员注册人数</div>
            <div class="text-yellow-700 text-xs">10000</div>
    ...
    >
      <div class="flex-1 mx-3 my-2">
        <div class="text-purple-500">母币</div>
        <div class="border-2 border-solid border-white h-96">
