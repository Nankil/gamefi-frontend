...
<template>
  ...
  height: 130px;">
                    ...
                    >當前權限階級</span>
                    <div class="level-now">
                        <span class="vip-level">一般会员</span>
                        <span class="lunci">(种子轮)</span>
                    </div>
  ...
  height: 230px;">
                    ...
                    <div class="level-next">
                        <span class="vip-level">黄金会员</span>
                        <span class="lunci">(种子轮)</span>
                    </div>
            ...
            <div class="rule" style="height: 127px; width: 1558px; position: relative; top: 0px;">
            ...
            color: #525252;"
                    ...
                    <tr>
                        <td style=" background-color:#ffffff; ">
                            ...
                            <div
                                style="display:block; align-items: center; position:absolute; left: 150px;top:1600px;"
                            >
                                <img class="level-icon" src="/imgs/一般.svg" alt />
                                <p
              ...
              color: #525252;"
                        ...
                        <td style=" background-color:#ffffff; ">row 1, cell 2</td>
                        <td style=" background-color:#ffffff; ">row 1, cell 3</td>
                    </tr>
                </table>
            </div>
